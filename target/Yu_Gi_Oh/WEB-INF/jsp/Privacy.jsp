...
<div class="container">
  ...
  <p>
    Rispettiamo la tua privacy e ci impegniamo a proteggere le tue informazioni personali. La presente politica sulla privacy descrive come raccogliamo, utilizziamo e proteggiamo i tuoi dati quando utilizzi il nostro sito web.
  </p>
</div>
...
<div class="tos">
  ...
  <p>
    Benvenuto su <strong>Yu_Gi_Oh</strong>. I seguenti Termini e Condizioni regolano l'accesso e l'utilizzo del nostro sito web www.Yu_Gi_Oh.com e dei servizi da noi offerti. Utilizzando il nostro sito, accetti di rispettare questi Termini e Condizioni. Se non accetti questi termini, ti invitiamo a non utilizzare il nostro sito.<br>

    1. Accettazione dei Termini<br>
    ...
    4. Acquisti e Pagamenti<br>
    Gli acquisti sul nostro sito sono soggetti a disponibilità. Accetti di pagare tutti gli importi indicati al momento dell'ordine, inclusi i costi di spedizione, le tasse e altri oneri applicabili. I pagamenti devono essere effettuati tramite i metodi di pagamento supportati.<br>

    5. Politica di Spedizione<br>
    ...
    8. Comportamento dell'Utente<br>
    L'utente si impegna a non utilizzare il sito per scopi illegali o non autorizzati. L'utente non dovrà caricare contenuti che violino i diritti di proprietà intellettuale di terzi, contenuti offensivi, diffamatori o inappropriati.<br>

    9. Modifiche ai Termini e Condizioni<br>
    Ci riserviamo il diritto di modificare questi Termini e Condizioni in qualsiasi momento. Le modifiche diventeranno effettive non appena pubblicate sul nostro sito. Ti consigliamo di rivedere periodicamente questa pagina per essere informato su eventuali modifiche.<br>

    10. Limitazione di Responsabilità<br>
